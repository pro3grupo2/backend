...
<p style="margin: 0; margin-bottom: 18px;">Su Proyecto ha sido rechazado debido a alguno de lo siguientes motivos:</p>
<p style="margin: 0; margin-bottom: 18px;">Le faltan contenidos: Comprueba que has subido bien la portada y el&nbsp; &nbsp; &nbsp; &nbsp; &nbsp; documento o que los enlaces funcionan bien.</p>
<p style="margin: 0; margin-bottom: 18px;">&nbsp;</p>
<p style="margin: 0; margin-bottom: 18px;">Su proyecto está repetido: Comprueba si su proyecto no lo ha subido ya otro compañero, sobre todo si se trata de un trabajo grupal.</p>
<p style="margin: 0;"><br>No cumple con las normas de la plataforma: El proyecto incumple con las normas establecidas por el centro y/o la plataforma</p>
</div>
</td>
</tr>
</table>
...
<div class="fullWidth" style="max-width: 357.5px;"><img src="imagen3" style="display: block; height: auto; border: 0; width: 100%;" width="357.5"/></div>
</div>
</td>
</tr>
</table>
...
<td class="pad" style="padding-bottom:25px;padding-left:60px;padding-right:60px;padding-top:20px;">
<div style="color:#101112;direction:ltr;font-family:Arial, Helvetica Neue, Helvetica, sans-serif;font-size:16px;font-weight:400;letter-spacing:0px;line-height:120%;text-align:justify;mso-line-height-alt:19.2px;">
<p style="margin: 0;">Si tienes alguna duda puedes acudir al coordinador que lo ha rechazado o al centro de ayuda.<br/><br/>Equipo de U-tad</p>
</div>
</td>
</tr>
</table>
...
<tr>
<td class="divider_inner" style="font-size: 1px; line-height: 1px; border-top: 1px solid #343840;"><span> </span></td>
</tr>
</table>
</div>
</td>
